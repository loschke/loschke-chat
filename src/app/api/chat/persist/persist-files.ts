...
export async function persistFilePartsToR2(
  ...
  // ⚡ Bolt: Run R2 uploads and text extractions concurrently.
  // Sequential for...of loop was adding O(n) latency for multi-file uploads.
  // Promise.all with map preserves array order while executing I/O in parallel,
  // reducing total wait time to roughly max(file_processing_times).
